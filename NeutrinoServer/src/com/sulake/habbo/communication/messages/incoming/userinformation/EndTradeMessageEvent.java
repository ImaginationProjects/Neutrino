...
import com.sulake.habbo.communication.messages.outgoing.userinformation.EndTradeMessageComposer;
...
public class EndTradeMessageEvent extends MessageEvent implements Runnable {
    ...
    public void run()
    {
    	try {
    		...
    		EndTradeMessageComposer.Compose(Client, User);
    	} catch (Exception e)
    	{
    		Server.WriteLine(e);
    	}
