...
import com.sulake.habbo.communication.messages.outgoing.administration.PerformRoomActionMessageComposer;
import com.sulake.habbo.communication.messages.outgoing.administration.SendAlertToUserMessageComposer;
...
public class PerformRoomActionMessageEvent extends MessageEvent implements Runnable {
    ...
    public void run()
    {
    	try {
    		...
    		PerformRoomActionMessageComposer.Compose(Client, User, Server);
