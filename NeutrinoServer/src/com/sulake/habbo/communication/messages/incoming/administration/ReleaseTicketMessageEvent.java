...
import com.sulake.habbo.communication.messages.outgoing.administration.ReleaseTicketMessageComposer;
...
public class ReleaseTicketMessageEvent extends MessageEvent implements Runnable {
    ...
    public void run()
    {
    	try {
    		...
    		ReleaseTicketMessageComposer.Compose(Client, User, Server);
