...
import com.sulake.habbo.communication.messages.outgoing.administration.LoadCFHChatlogMessageComposer;
...
public class LoadCFHChatlogMessageEvent extends MessageEvent implements Runnable {
    ...
    public void run()
    {
    	try {
    		...
    		LoadCFHChatlogMessageComposer.Compose(Client, User, Server);
