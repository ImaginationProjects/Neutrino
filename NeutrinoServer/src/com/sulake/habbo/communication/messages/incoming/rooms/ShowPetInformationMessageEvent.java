...
import com.sulake.habbo.communication.messages.outgoing.rooms.ShowPetInformationMessageComposer;

public class ShowPetInformationMessageEvent extends MessageEvent implements Runnable {
    ...
    public void run()
    {
    	try {
    		...
    		ShowPetInformationMessageComposer.Compose(Client, User, Server);
    	} catch (Exception e)
    	{
    		Server.WriteLine(e);
    	}
