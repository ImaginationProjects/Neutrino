...
import com.sulake.habbo.communication.messages.outgoing.userinformation.RemoveTradeObjectMessageComposer;
...
public class RemoveTradeObjectMessageEvent extends MessageEvent implements Runnable {
    ...
    public void run()
    {
    	try {
    		...
    		RemoveTradeObjectMessageComposer.Compose(Client, User);
    	} catch (Exception e)
    	{
    		Server.WriteLine(e);
    	}
