...
import com.sulake.habbo.communication.messages.outgoing.userinformation.ConfirmTradeMessageComposer;
...
public class ConfirmTradeMessageEvent extends MessageEvent implements Runnable {
    ...
    public void run()
    {
    	try {
    		...
    		ConfirmTradeMessageComposer.Compose(Client, User, Server);
    	} catch (Exception e)
    	{
    		Server.WriteLine(e);
    	}
