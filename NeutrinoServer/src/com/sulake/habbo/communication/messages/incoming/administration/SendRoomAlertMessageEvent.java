...
import com.sulake.habbo.communication.messages.outgoing.administration.SendRoomAlertMessageComposer;
...
public class SendRoomAlertMessageEvent extends MessageEvent implements Runnable {
    ...
    public void run()
    {
    	try {
    		...
    		SendRoomAlertMessageComposer.Compose(Client, User, Server);
