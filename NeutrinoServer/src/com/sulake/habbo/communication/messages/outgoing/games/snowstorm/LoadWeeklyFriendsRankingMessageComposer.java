...
public class LoadWeeklyFriendsRankingMessageComposer {
	public static void Compose(ServerHandler Client, Habbo cUser, Environment Server) throws Exception
	{
        ...
        Collections.sort(FriendsData, new Comparator<Habbo>() {
    		...
    		{
    			return Integer.valueOf(e2.SnowWarWeeklyScore).compareTo(e1.SnowWarWeeklyScore);
    		}
    	});
        
    	ServerMessage Board = new ServerMessage(ServerEvents.WeeklyFriendsLeaderBoard);
