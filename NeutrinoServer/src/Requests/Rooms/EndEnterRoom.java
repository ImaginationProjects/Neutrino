 ...
 * @author cb2z8eb
 */
public class EndEnterRoom extends Handler implements Runnable {
    ...
    public void run() {
        ...
        while(reader.hasNext())
        {
            ...
            RoomItems.writeInt(-1);
            RoomItems.writeBoolean((furnidata.Interactor.equals("default")) ? true : false);
            RoomItems.writeInt(R.OwnerId);
        }
        ...
        ServerMessage ExtraData = new ServerMessage(ServerEvents.RoomData7);
