 ...
 */
package neutrino.Net.ThreadPool;
import neutrino.Environment;
import java.util.concurrent.*;
import neutrino.Net.ThreadPool.PriorityThreadFactory;
/**
 *
 * @author Julián
 */
public class ThreadPoolManager {
    ...
    public static void Init(Environment Server)
    {
        ...
        _myPacketThreads = new CachedThreadPoolExecutor(5, ThreadConfigurator.MAX_THREADS, ThreadConfigurator.MAX_TIME_WITHOUT_WARN, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(),
